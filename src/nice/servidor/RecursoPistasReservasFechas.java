 ...
 * @author aulas
 */
public class RecursoPistasReservasFechas extends ServerResource{
    ...
    private String fecha;
      ...
      mapper.configure(SerializationFeature.FAIL_ON_EMPTY_BEANS, false);
        ...
        codigoPista=getAttribute("codigoPista");
        /////
        nombrePista=codigoPista;
        fecha=getAttribute("fecha");
    ...
    public String devolver() {
            ...
            tablaReservas=servicioRestTorneos.getTablaReservas(codigoPista,nombrePista,fecha);
            
        try {
          
            serializado=mapper.writeValueAsString(tablaReservas);
    
          } catch (JsonProcessingException ex) {
            Logger.getLogger(RecursoPistasReservasFechas.class.getName()).log(Level.SEVERE, null, ex);
        }
          return serializado;
