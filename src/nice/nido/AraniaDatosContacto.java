...
/**
 * Obtiene los datos de contacto en la web del CAD para cada campus donde hay
...
public class AraniaDatosContacto extends Arania {
    ...
    /**
     * Constructor con la URL base de la página de información de contacto.
     *
     * @param baseUrl URL de la página de información de contacto.
     */
    ...
    /**
     * Método para extraer la información de la web indicada en la URL.
     *
     * @return Lista de datos de contacto por cada campus.
     */
    ...
    /**
     * Método que permite lanzar la araña independientemente, por línea de
     * comandos.
     *
    ...
    /**
     * Formatea un String que contiene un número de teléfono, para contener una
     * representación más compacta, con sólo dígitos.
     *
    ...
    /**
     * Formatea un String que contiene varios números de teléfono, para contener
     * una representación más compacta, con sólo dígitos.
     *
     * @param valor String que representa a varios números de teléfono,
     * separados por "," o "y".
